      ...
      <div className="relative z-10">
          ...
          <div className="grid gap-10 md:grid-cols-2">
            <div className="space-y-4 text-sm leading-relaxed text-ink-muted">
              ...
              <p>
                ...
                and finds a match. The address belongs to the NOXFUNDS program,
                so only the NOXFUNDS program can authorise it.
              </p>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            <div className="border-l-2 border-brand pl-5">
              ...
              <p className="mt-2 text-sm leading-relaxed text-ink-muted">
                <span className="text-ink">Risk per trade</span> is checked
                before the fill, and it is only checkable because the stop-loss
                is mandatory and lands in the same transaction as the position.
                A centralised firm can only measure your risk once you already
                have the position.
              </p>
            </div>
            <div className="border-l-2 border-line pl-5">
              ...
              <p className="mt-2 text-sm leading-relaxed text-ink-muted">
                ...
                stop-out is exempt — forcing a trader to sit in a losing
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,420px)_1fr]">
            ...
            <div className="space-y-5 text-sm leading-relaxed text-ink-muted">
              <p>
                ...
                first, so the 70/30 split stays exactly 70/30 on what remains.
                The alternative — a three-way 70/25/5 — would quietly cut the
                investor to 25%.
              </p>
              <p>
                <span className="text-ink">
                ...
                That is what "the investor bears the trading loss" means in
                money.
              </p>
              <div>
                <div className="text-[10px] uppercase tracking-[0.16em] text-ink-dim">
        ...
        >
          <p className="mb-8 max-w-3xl text-sm leading-relaxed text-ink-muted">
            ...
            wins and enormous losses — the most common way a track record lies.
            So win rate never decides a tier on its own. Profit factor and worst
          ...
          <p className="mt-6 max-w-3xl text-sm leading-relaxed text-ink-muted">
            ...
            computed from trades inside a mandate that is still open. Silver
            also requires a 45% win rate as an additional condition.
          </p>
        </Section>
        ...
        >
          ...
          <p className="mt-6 max-w-3xl text-sm leading-relaxed text-ink-muted">
            ...
            and closing a position in the same minute: you pay the spread and
            the fee in both directions. The protocol earned nothing from any of
            them, exactly as designed. They are shown as they are because a page
            that only lists wins is the thing this product exists to replace.
          </p>
        ...
        >
          <div className="grid gap-8 md:grid-cols-3">
            <div>
              ...
              <ul className="mt-3 space-y-2 text-sm text-ink-muted">
                <li>
                  The evaluation stage — mandates are funded directly today
                </li>
