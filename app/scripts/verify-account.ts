...
async function main() {
  ...
  const owner = (process.argv[2] ?? "7ktphnZe9rER59HanbM6mDk9aDAbvc2pcjDcPWDvBdWs") as Address;
  ...
  console.log(`user account     ${s.userAccountPda}  ${s.hasUserAccount ? "exists" : "MISSING"}`);
