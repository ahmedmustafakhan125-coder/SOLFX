...
> = {
  ...
  nonce: OpenPositionInstructionDataArgs["nonce"];
  direction: OpenPositionInstructionDataArgs["direction"];
  sizeBase: OpenPositionInstructionDataArgs["sizeBase"];
  collateral: OpenPositionInstructionDataArgs["collateral"];
  priceLimit: OpenPositionInstructionDataArgs["priceLimit"];
};
