...
export type IncreasePositionAsyncInput<
...
> = {
  ...
  sizeDelta: IncreasePositionInstructionDataArgs["sizeDelta"];
  collateralDelta: IncreasePositionInstructionDataArgs["collateralDelta"];
  priceLimit: IncreasePositionInstructionDataArgs["priceLimit"];
};

export async function getIncreasePositionInstructionAsync<
  TAccountAuthority extends string,
  TAccountProtocol extends string,
  TAccountUserAccount extends string,
  TAccountMarket extends string,
...
>(
  input: IncreasePositionAsyncInput<
    TAccountAuthority,
    TAccountProtocol,
    TAccountUserAccount,
    TAccountMarket,
...
> {
  ...
  return Object.freeze({
    ...
    data: getIncreasePositionInstructionDataEncoder().encode(
      args as IncreasePositionInstructionDataArgs,
    ),
    programAddress,
