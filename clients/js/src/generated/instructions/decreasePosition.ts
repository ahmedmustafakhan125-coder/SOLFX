...
export type DecreasePositionAsyncInput<
...
> = {
  ...
  sizeDelta: DecreasePositionInstructionDataArgs["sizeDelta"];
  priceLimit: DecreasePositionInstructionDataArgs["priceLimit"];
};

export async function getDecreasePositionInstructionAsync<
  TAccountAuthority extends string,
  TAccountProtocol extends string,
  TAccountUserAccount extends string,
  TAccountMarket extends string,
...
>(
  input: DecreasePositionAsyncInput<
    TAccountAuthority,
    TAccountProtocol,
    TAccountUserAccount,
    TAccountMarket,
...
> {
  ...
  return Object.freeze({
    ...
    data: getDecreasePositionInstructionDataEncoder().encode(
      args as DecreasePositionInstructionDataArgs,
    ),
    programAddress,
