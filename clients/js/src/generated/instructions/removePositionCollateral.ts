...
export const REMOVE_POSITION_COLLATERAL_DISCRIMINATOR = new Uint8Array([
  112, 178, 224, 30, 186, 194, 0, 133,
]);

export function getRemovePositionCollateralDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    REMOVE_POSITION_COLLATERAL_DISCRIMINATOR,
  );
}

export type RemovePositionCollateralInstruction<
...
export type RemovePositionCollateralInstructionData = {
  discriminator: ReadonlyUint8Array;
  amount: bigint;
};

export type RemovePositionCollateralInstructionDataArgs = {
  amount: number | bigint;
};

export function getRemovePositionCollateralInstructionDataEncoder(): FixedSizeEncoder<RemovePositionCollateralInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: REMOVE_POSITION_COLLATERAL_DISCRIMINATOR,
    }),
  );
}

export function getRemovePositionCollateralInstructionDataDecoder(): FixedSizeDecoder<RemovePositionCollateralInstructionData> {
...
export function getRemovePositionCollateralInstructionDataCodec(): FixedSizeCodec<
  RemovePositionCollateralInstructionDataArgs,
  RemovePositionCollateralInstructionData
> {
  return combineCodec(
    getRemovePositionCollateralInstructionDataEncoder(),
    getRemovePositionCollateralInstructionDataDecoder(),
  );
}

export type RemovePositionCollateralAsyncInput<
...
> = {
  ...
  amount: RemovePositionCollateralInstructionDataArgs["amount"];
};

export async function getRemovePositionCollateralInstructionAsync<
  TAccountAuthority extends string,
  TAccountProtocol extends string,
  TAccountUserAccount extends string,
  TAccountMarket extends string,
...
>(
  input: RemovePositionCollateralAsyncInput<
    TAccountAuthority,
    TAccountProtocol,
    TAccountUserAccount,
    TAccountMarket,
  ...
  RemovePositionCollateralInstruction<
    TProgramAddress,
    TAccountAuthority,
    TAccountProtocol,
    TAccountUserAccount,
...
> {
  ...
  return Object.freeze({
    ...
    data: getRemovePositionCollateralInstructionDataEncoder().encode(
      args as RemovePositionCollateralInstructionDataArgs,
    ),
    programAddress,
  } as RemovePositionCollateralInstruction<
    TProgramAddress,
    TAccountAuthority,
    TAccountProtocol,
    TAccountUserAccount,
...
export type RemovePositionCollateralInput<
  TAccountAuthority extends string = string,
  TAccountProtocol extends string = string,
  TAccountUserAccount extends string = string,
  TAccountMarket extends string = string,
...
export function getRemovePositionCollateralInstruction<
  TAccountAuthority extends string,
  TAccountProtocol extends string,
  TAccountUserAccount extends string,
  TAccountMarket extends string,
  ...
  TProgramAddress extends Address = typeof SOLFX_CORE_PROGRAM_ADDRESS,
>(
  input: RemovePositionCollateralInput<
    TAccountAuthority,
    TAccountProtocol,
    TAccountUserAccount,
    TAccountMarket,
...
export type ParsedRemovePositionCollateralInstruction<
  TProgram extends string = typeof SOLFX_CORE_PROGRAM_ADDRESS,
...
> = {
  ...
  data: RemovePositionCollateralInstructionData;
};

export function parseRemovePositionCollateralInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedRemovePositionCollateralInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getRemovePositionCollateralInstructionDataDecoder().decode(
      instruction.data,
    ),
  };
}
